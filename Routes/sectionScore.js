...
router.route('/api/v1/section-score/:candidate_id').get(protect, authorizeAdmin, getAllCandidateScores)
router.route('/api/v1/section-score/:test_id').get(protect, authorizeAdmin, getAllTestScores)
router.route('/api/v1/section-score/:section_id').get(protect, authorizeAdmin, getAllSectionScores)
router.route('/api/v1/section-score/:section_id/:candidate_id').get(protect, authorizeAdmin, getCandidateSectionScores)
router.route('/api/v1/section-score/self').get(protect, authorize, getAllSelfScores)
router.route('/api/v1/section-score/self/:section_id').get(protect, authorize, getSelfSectionScores)
